      ...
      <div className="relative z-10">
        ...
        <div className="mt-[1rem] flex flex-col">
          ...
          <input
            ...
            name="email"
            className="px-4 py-3 border-[2px] rounded-md outline-[#3498db] text-gray-800"
        ...
        <div className="mt-4 flex justify-end">
          <a
            ...
            className="font-bold text-[#3498db] text-[14px] hover:text-[#2980b9] transition-all duration-300"
          >
            Forgot password?
          </a>
        </div>
