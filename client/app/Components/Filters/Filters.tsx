...
function Filters() {
  ...
  return (
    <div className="relative py-2 px-2 grid grid-cols-4 items-center gap-3 bg-[#F9F9F9] dark:bg-[#3C3C3C]/60 border-2 border-white rounded-md dark:border-[#6B6B6B]">
      <span
        className="absolute left-[5px] bg-[#EDEDED] dark:bg-[#3C3C3C]/60 rounded-md transition-all duration-300"
        style={{
